    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="fare_estimate" mb="4" isInvalid={!!formik.errors?.fare_estimate}>
            <FormLabel>Fare Estimate</FormLabel>
            <NumberInput
              name="fare_estimate"
              value={formik.values?.fare_estimate}
              onChange={(valueString, valueNumber) =>
                formik.setFieldValue('fare_estimate', Number.isNaN(valueNumber) ? 0 : valueNumber)
              }
            >
              <NumberInputField />
              <NumberInputStepper>
            ...
            {formik.errors.fare_estimate && <FormErrorMessage>{formik.errors?.fare_estimate}</FormErrorMessage>}
          </FormControl>
