...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'accountant', 'customer-support', 'driver'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Driver', path: '/drivers', entity: 'driver', service: AccessServiceEnum.PROJECT, icon: FiTruck },
    {
      name: 'Emergency',
      path: '/emergencies',
      entity: 'emergency',
    ...
    { name: 'Ride', path: '/rides', entity: 'ride', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Ride History',
      path: '/ride-histories',
      entity: 'ride_history',
